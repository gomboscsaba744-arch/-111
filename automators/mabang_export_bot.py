...
async def run_mabang_export(user_data_dir: str, days: int = 1, hours: int = 0, customer_id: str = '1000000257', headless: bool = False, progress_callback=None, task_info=None):
    def log(msg):
        print(msg)
        if task_info:
        ...
        try:
            ...
            try:
                ...
                if not abn_col:
                    ...
                    log(f"[*] 进度提示：已成功生成更新模板，共 {len(df)} 条订单数据")
